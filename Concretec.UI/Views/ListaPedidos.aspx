<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/MasterPage.master" AutoEventWireup="true"
    CodeFile="ListaPedidos.aspx.cs" Inherits="Views_ListaPedidos" EnableEventValidation="false" EnableViewStateMac="False" %>
                ...
                <table cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:ImageButton ID="btnnuevo" runat="server" EnableViewState="False" ForeColor="#000020" Height="35px" ImageUrl="~/MetroImages/NuevoElemento.png" OnClick="btnnuevo_Click" />
