...
public partial class Views_Planeacion : System.Web.UI.Page
{
    ...
    {
        CargaPlantasCombo(DatosUsuario.Ciudad);
    ...
    private void CargaPlantasCombo(string CveCiudad)
    {
        ...
        item.Value = "-1";
        item.Checked = true;
        this.rcboplanta.Items.Add(item);
    ...
    protected void btnBuscar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        int[] seleccionados = rcboplanta.GetCheckedIndices();

        //int[] seleccionados= selplantas.GetSelectedIndices();
        foreach (int valor in seleccionados)
        {
            Listaads = Listaads + rcboplanta.Items[valor].Value + "|";
        }
    ...
    protected void btnBombasr_Click(object sender, ImageClickEventArgs e)
    {
        Response.Redirect("PlaneacionBombas.aspx?Fecha=" + DateTime.Now.ToShortDateString());
    }
}