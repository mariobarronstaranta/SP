<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Shared/MasterPage.master"
    CodeFile="ListaClientes.aspx.cs" Inherits="Views_ListaClientes" EnableEventValidation="false" %>
            ...
            <div style="text-align: left;">
                <table cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td>
                            <telerik:RadComboBox ID="cboplantas" runat="server" Skin="Metro" Width="200px"> </telerik:RadComboBox></td>
                        ...
                        <td style="text-align: right;">
                            <asp:ImageButton ID="btnAutorizaciones" runat="server" ImageUrl="~/MetroImages/Autoriza.png"
                                OnClick="btnAutorizaciones_Click" Height="35px"/>
                        <td style="text-align: right;">
            ...
            <tr>
                <td>
                    <telerik:RadGrid ID="gridClientes" runat="server" GridLines="None" AllowPaging="True"
                        AutoGenerateColumns="False" OnNeedDataSource="gridClientes_NeedDataSource"
