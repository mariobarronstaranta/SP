...
}g.click(function(){var i=h.parents(".rsAdvancedModal");
var j={duration:"slow"};
if($telerik.isIE6||$telerik.quirksMode){j={duration:"slow",step:function(){if(i.length){i[0].style.cssText=i[0].style.cssText;
}}};
}h.stop(false,true).animate({height:"toggle"},j);
});
},_getRecurrentCheckBox:function(){return this._getElement("RecurrentAppointment");
