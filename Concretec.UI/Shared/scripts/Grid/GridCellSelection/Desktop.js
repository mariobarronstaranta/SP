...
l.selectable=new Telerik.Web.UI.Extensions.Selectable(l._owner.get_element(),{filter:"tr[id] > td:visible",multiple:l.get_multiple(),multiColumnSelect:l.get_multiColumnSelect(),owner:l._owner,styles:{SELECTED:"rgSelectedCell",ACTIVE:"rgFocusedCell",UNSELECTING:"web-ui-state-unselecting",MARQUEE:k},change:function(){}});
...
if(k!==i&&k.length){if(!j||j[0]!==k[0]){k.addClass(f);
