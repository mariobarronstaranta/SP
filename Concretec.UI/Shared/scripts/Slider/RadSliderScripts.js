...
}},_setWidth:function(){var i=parseInt(this._width,10);
var j=f(this._width);
if(!isNaN(i)&&(i>0)){if(this._renderMode===b.RenderMode.Lite&&j!==null){i+=j;
}else{i+="px";
}var h=this.get_element();
var k=this._wrapperElement;
if(h.style.width!=i){h.style.width=i;
}if(k.style.width!=i){k.style.width=i;
