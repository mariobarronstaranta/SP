...
var m=a.getElementsByTagName("input")[0];
...
}if(this._resizedControlWidth){b.resizedControlWidth=this._resizedControlWidth;
}if(this._displayColumns){b.displayColumns=this._displayColumns;
}if(this._reorderedColumns){b.reorderedColumns=this._reorderedColumns;
