...
j<h.length;
j++){var k;
if($telerik.isIE8||$telerik.isIE7||$telerik.isIE6){k=a.inArray(h[j],m);
...
}if($telerik.isIE6){a(window).bind("resize."+this.get_id(),function(){m.repaint();
});
...
}}else{if(($telerik.isIE6||$telerik.isIE7||$telerik.isIE8||$telerik.isIE9Mode||$telerik.quirksMode)&&(i.get(0).style.height!=="")){if($telerik.isIE9Mode){var o=h.find(".rlbGroupCell");
o.height("auto");
o.height(o.height());
...
}if(p.hasClass("rlbGroupTop")||p.hasClass("rlbGroupBottom")){p.each(function(){var x=a(this);
i=x.parents(".rlbGroupCell");
if(!i.length){i=x.parent();
}var E;
if(i[0].style.height!==""){E=parseInt(i[0].style.height,10);
}else{E=i.height();
}var y=i.children(".rlbButtonAreaBottom");
var z=i.children(".rlbButtonAreaTop");
var C=y.length>0?y[0].offsetHeight:0;
var F=z.length>0?z[0].offsetHeight:0;
var B=f(x,"border-top-width");
var A=f(x,"border-bottom-width");
var D=E-C-F-B-A;
if(x.height()!=D){x.height(D);
}});
}if(p.hasClass("rlbGroupLeft")||p.hasClass("rlbGroupRight")){p.each(function(){var y=a(this);
i=y.parents(".rlbGroupCell");
if(!i.length){i=y.parent();
}var z=f(y,"border-left-width");
var A=f(y,"border-right-width");
var B=0;
var x=i.find(".rlbButtonAreaLeft td, .rlbButtonAreaRight td");
if(x.length>0){B+=x[0].clientWidth+z+A+3;
}var C;
if(i[0].style.width!==""&&i[0].style.width.search("%")==-1){C=parseInt(i[0].style.width,10);
}else{C=i.outerWidth();
}if(h.length&&(a(v).get(0).style.height!=="")){x=a(v).find(".rlbButtonAreaLeft td, .rlbButtonAreaRight td");
if(x.length>0){B+=x.get(0).clientWidth+f(h,"border-left-width")+f(h,"border-right-width");
}h.width(C-B);
if($telerik.quirksMode){B+=2;
}}y.width(C-B-2);
});
}p.each(function(){var y=a(this);
var x=y.children(".rlbList");
var z=x.width();
if(x.css("display")=="inline"&&i.width()>z&&z!="100%"){x.width("100%");
}});
};
